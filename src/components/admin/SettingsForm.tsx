...
export default function SettingsForm({ fields, values }: Props) {
  ...
  return (
    <div className="max-w-5xl">
      <div className="sticky top-[calc(3.5rem+env(safe-area-inset-top))] lg:top-0 z-10 -mx-1 mb-10 flex flex-wrap items-center justify-between gap-4 bg-ink/95 px-1 py-4 backdrop-blur">
        <div>
