export const DEALER = {
  ...
  email: process.env.DEALER_EMAIL || process.env.LEADS_NOTIFY_TO || 'hello@dreamdriveauto.ca',
  address: process.env.DEALER_ADDRESS || 'London, ON',
  website: process.env.DEALER_WEBSITE || 'https://dreamdriveauto.ca',
  hours: [
